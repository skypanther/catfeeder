...
ap.add_argument("-m", "--mask-rcnn", required=False,
...
for i in range(0, boxes.shape[2]):
    ...
    if confidence > args["confidence"]:
        ...
        if args["visualize"] > 0:
            ...
            # if color_analyzer.is_right_cat_visible(instance, show_windows=bool(args["visualize"])):
            #     print("big orange area, probably Marmalade")
            # rgb, hsv = color_analyzer.get_dominant_colors(instance)
            # print("RGB colors:")
            # print(rgb)
            # print("HSV colors:")
            # print(hsv)
